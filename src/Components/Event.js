...
const Event = () => {
  return (
    <section id="event" className="py-2">
      <div className="container flex flex-col md:flex-row md:mx-auto md:justify-center my-5 space-y-0">
        <div className="flex flex-col mb-10 md:w-1/2">
          <div className="space-y-12 py-6">
            <h1 className=" text-3xl font-bold md:text-2xl md:text-left text-center">
              Welcome to my website
            </h1>
            <p className="text-md text-center items-center md:text-left  max-w-md">
        ...
        <div className="flex justify-center md:justify-start w-1/2 mr-10">
