...
const Feature = () => {
  return (
    <section id="feature" className="md:py-2">
      <div className="container flex  md:flex-row   mx-2 md:mx-auto mt-10 space-y-0 space-x-4">
        ...
        <div className="flex flex-col space-y-5  pt-2 md:w-1/2">
          <div className="space-y-6 py-6 px-2">
            <h1 className="max-w-md text-4xl font-bold text-center md:text-xl md:text-left md:justify-center">
